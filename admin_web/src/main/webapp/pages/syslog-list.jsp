...
<body class="hold-transition skin-blue sidebar-mini">
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							...
							<c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
								<li><a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${pageInfo.pageNum}&pageSize=${pageInfo.pageSize}">${pageNum}</a></li>
							</c:forEach>
	...
	<script>
		function changePageSize() {
			...
			//向服务器发送请求，改变没页显示条数
			location.href = "${pageContext.request.contextPath}/sysLog/findAll.do?page=1&pageSize=" + size;
		}
